...
{ 
    ...
    {
        private static final String SurroundingPath = "SurroundingPath.";
    ...
    {
        private static final String HoveringPath = "HoveringPath.";
    ...
    {
        private static final String HighlightsPath = "HighlightsPath.";
